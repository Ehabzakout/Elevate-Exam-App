import { icons } from "@/components/features/exam/quiz-component";
...
export default async function page() {
  ...
  // API is not localhost in production
  ...
  return (
    <div className="mt- space-y-6">
      ...
      {exams?.map((exam) => {
        ...
        const { id, title, numberOfQuestions, duration, WrongQuestions } = exam;
